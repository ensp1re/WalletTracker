# 💼 Wallet Tracker Client

Welcome to the **Wallet Tracker** client! This project is built using **React**, **TypeScript**, **Vite**, **ether.js**, **shadcn**, and other amazing technologies. 🚀
